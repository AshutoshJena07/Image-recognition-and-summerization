    ...
    <div className="dash-shell">
      ...
      <header className="dash-header">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', fontSize: '11px' }}>
            <span style={{ fontWeight: 600 }}>{user?.email || 'Logged In'}</span>
            <span style={{ color: 'var(--muted)' }}>User Account</span>
          </div>
          <button onClick={logout} className="toggle-button" style={{ borderColor: '#ef4444', color: '#ef4444' }}>
            Sign Out
          </button>
        </div>
      </header>
      ...
      <main className="dash-body">
        ...
        <section className="dash-welcome">
          <h1 style={{ fontSize: '28px', fontFamily: 'var(--font-heading)', fontWeight: 800 }}>
        ...
        <div className="dash-top-grid">
          ...
          >
            ...
            <h3>Quick Launch File Session</h3>
            ...
            <label className="dash-upload-label" style={{ marginTop: '14px' }}>
              Browse Files
          ...
          <div className="dash-templates-card">
            <h3 style={{ fontSize: '14px', textTransform: 'uppercase', letterSpacing: '0.05em', color: 'var(--muted)', marginBottom: '12px' }}>
              Workspace Presets
            </h3>
        ...
        <section style={{ marginTop: '32px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            <h2 style={{ fontSize: '18px', fontFamily: 'var(--font-heading)', fontWeight: 700 }}>
